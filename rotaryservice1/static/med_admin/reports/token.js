...
$("#export-btn").on("click", async function() {
    ...
    if (type === "pdf") {
        ...
        doc.text("Token Report", pageWidth / 2, topMargin + 25, { align: "center" });
        ...
        doc.autoTable({
            startY: cursorY,
            head: [["SL","Name","Contact","Age","Code","Pin", "Token", "Added on","Department","Token Issued"]],
            body: tableData,
            styles: {
                font: "NotoMalayalam",
                fontSize: 8,
...
if (type === "excel") {
    ...
    reportRow.getCell(1).value = "Token Report";
    ...
    // ===== Headers =====
    const headers = ["SL","Name","Contact","Age","Code","Pin", "Token", "Added on","Department","Token Issued"];
    ...
    link.download = safeFileName("Token Report") + ".xlsx";
    link.click();
}
